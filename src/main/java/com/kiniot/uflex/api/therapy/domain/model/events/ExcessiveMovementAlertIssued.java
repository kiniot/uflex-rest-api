...
@Getter
public class ExcessiveMovementAlertIssued extends ApplicationEvent {
    ...
    private ExcessiveMovementAlertIssued(Builder builder) {
    ...
    public static class Builder {
        ...
        public ExcessiveMovementAlertIssued build()   { return new ExcessiveMovementAlertIssued(this); }
    }
}
