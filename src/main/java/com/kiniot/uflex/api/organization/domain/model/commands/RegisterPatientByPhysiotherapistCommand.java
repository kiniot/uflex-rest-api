...
public record RegisterPatientByPhysiotherapistCommand(
        FirstName firstName,
        LastName lastName,
        Dni dni,
        BirthDate birthDate,
    ...
    public RegisterPatientByPhysiotherapistCommand {
        if (firstName == null) {
        ...
        if (assignedPhysiotherapistId == null) {
            throw new IllegalArgumentException("Assigned physiotherapist id cannot be null");
        }
    }
}
