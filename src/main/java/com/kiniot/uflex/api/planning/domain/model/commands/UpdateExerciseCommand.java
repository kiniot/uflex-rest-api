...
public record UpdateExerciseCommand(
    ...
    public UpdateExerciseCommand {
        if (exerciseId == null) throw new IllegalArgumentException("Exercise ID cannot be null");
        if (name == null) throw new IllegalArgumentException("Exercise name cannot be null");
        if (description == null) throw new IllegalArgumentException("Exercise description cannot be null");
        if (bodyPart == null) throw new IllegalArgumentException("Body part cannot be null");
        if (movementType == null) throw new IllegalArgumentException("Movement type cannot be null");
    }
}
